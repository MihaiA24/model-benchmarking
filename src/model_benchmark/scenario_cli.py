...
def main(argv: list[str] | None = None) -> int:
    """Run the non-interactive Scenario Package development shell."""
    parser = argparse.ArgumentParser(
        prog="model-benchmark-scenario",
        description="Author and qualify Scenario Packages.",
    )
    ...
    try:
        ...
        if arguments.json:
            ...
            print(
                f"scenario error [{error.classification}]: {error}",
                file=sys.stderr,
            )
        return 2
