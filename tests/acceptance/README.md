...
- Issues 29 and 55 mandate a responding Docker daemon; issue 51's canonical
  ...
  adds `--acceptance-input=functional-v1-minimax-m3.yaml`; issue 123 adds
  `--acceptance-input=functional-v1-hy3.yaml`. Each authored manifest participates in
  the Acceptance Source Tree / reproducibility identity
