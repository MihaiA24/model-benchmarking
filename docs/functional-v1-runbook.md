...
Every command reads one strict manifest. The committed DeepSeek, MiMo, and Hy3 examples are
`functional-v1-manifest.yaml`, `functional-v1-mimo-v2.5.yaml`, and
`functional-v1-hy3.yaml`; all state lives under `--home` (default `.model-benchmark`).
